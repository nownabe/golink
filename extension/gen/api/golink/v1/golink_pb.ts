...
/**
 * @generated from message api.golink.v1.Golink
 */
export class Golink extends Message<Golink> {
  ...
  static readonly typeName = "api.golink.v1.Golink";
...
/**
 * @generated from message api.golink.v1.CreateGolinkRequest
 */
export class CreateGolinkRequest extends Message<CreateGolinkRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.golink.v1.CreateGolinkRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "url", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message api.golink.v1.CreateGolinkResponse
 */
export class CreateGolinkResponse extends Message<CreateGolinkResponse> {
  /**
   * @generated from field: api.golink.v1.Golink golink = 1;
   */
  golink?: Golink;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.golink.v1.CreateGolinkResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
